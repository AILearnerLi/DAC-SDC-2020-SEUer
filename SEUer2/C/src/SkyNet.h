...
#define conv1_b 0 //ddrwidth=256, bias buf width=16 16*32=512, need 2 address
#define conv2_b 4 //in conv 1 need 2 for biasw and 2 for biasm so this from 4
#define conv3_b 12
#define conv4_b 20
#define conv5_b 32
#define conv6_b 44
...
void img_DT_2_DT16(ADT* in, ADT16* out, layer l);
